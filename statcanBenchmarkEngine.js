/**
 * StatCan Synthetic Econometric Benchmark Engine
 * Zero-dependency, UMD/ES6/CommonJS portable module for Statistics Canada SHS comparisons.
 * Can be imported in Node.js, browsers, or financial calculators.
 */
(function (global, factory) {
   ...
   */
  function computeBenchmark(options) {
  ...
  return {
    ...
    BASE_PROVINCIAL_SHS: BASE_PROVINCIAL_SHS,
    INCOME_ELASTICITY: INCOME_ELASTICITY,
    CMA_COST_INDEX: CMA_COST_INDEX,
    AGE_COHORT_MULTIPLIERS: AGE_COHORT_MULTIPLIERS
  };
});
