    ...
    return `
        <div class="report-section">
            ...
            <ul class="report-source-list">
                ...
                <li><strong>You can safely spend ${formatNumber(swr)}% of your portfolio each year.</strong> This "safe withdrawal rate" comes from research (Bengen, 1994) showing a balanced portfolio has historically lasted 30+ years at this pace. Spend much more and you risk running dry; spend less and you almost certainly leave money behind. Note that 4% was validated for roughly a 30-year retirement — if you plan to retire early and need 40–50 years of runway, many in the FIRE community use 3–3.5% as a more conservative target.</li>
                <li><strong>Financial independence means your portfolio meets the safe withdrawal rate.</strong> We treat you as independent at the earliest age your portfolio (combined with any guaranteed income) satisfies the ${formatNumber(swr)}% withdrawal rule — meaning it could, in principle, sustain your expenses indefinitely. This is deliberately cautious: meeting the SWR threshold doesn't just get you to age 100, it leaves a lasting buffer beyond.</li>
